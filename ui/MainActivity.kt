        ...
        if (bpmDiff >= bpmDiffSwitch) {
            ...
            if (elapsedSeconds >= switchDelaySeconds) {
                ...
                coroutineScope.launch {
                    spotifyManager.fadeVolume(1.0f, 0.0f, 1000L)
                    ...
                    spotifyManager.fadeVolume(0.0f, 1.0f, 1000L)
                }
            }
        } else {
            shiftStartTime = 0L
                ...
                onConnected = {
                    ...
                    lifecycleScope.launch {
                        ...
                        try {
                            ...
                            // Helper log to view DB count in Logcat
                            logAllDatabaseTracks(trackDao)

                            spotifyManager.observeTrackEnd(
