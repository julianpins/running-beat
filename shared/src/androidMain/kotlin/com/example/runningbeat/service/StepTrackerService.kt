...
import com.example.runningbeat.data.AndroidSettingsRepository
import com.example.runningbeat.data.AndroidStepSensor
...
class StepTrackerService : Service() {
    ...
    private lateinit var sensorManager: AndroidStepSensor
    ...
    override fun onCreate() {
        super.onCreate()
        sensorManager = AndroidStepSensor(this)
