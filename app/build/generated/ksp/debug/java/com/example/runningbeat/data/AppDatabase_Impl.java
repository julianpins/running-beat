  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `tracks` (`uri` TEXT NOT NULL, `title` TEXT NOT NULL, `artist` TEXT NOT NULL, `bpm` INTEGER NOT NULL, `playCount` INTEGER NOT NULL, `durationMs` INTEGER NOT NULL, `isFallback` INTEGER NOT NULL, PRIMARY KEY(`uri`))");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_tracks_bpm` ON `tracks` (`bpm`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '301209fc4a249e8c0748713621e3a17e')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsTracks.put("uri", new TableInfo.Column("uri", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsTracks.put("bpm", new TableInfo.Column("bpm", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsTracks.put("isFallback", new TableInfo.Column("isFallback", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _indicesTracks.add(new TableInfo.Index("index_tracks_bpm", false, Arrays.asList("bpm"), Arrays.asList("ASC")));
        ...
        if (!_infoTracks.equals(_existingTracks)) {
          return new RoomOpenHelper.ValidationResult(false, "tracks(com.example.runningbeat.data.TrackEntity).\n"
                  + " Expected:\n" + _infoTracks + "\n"
                  + " Found:\n" + _existingTracks);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "301209fc4a249e8c0748713621e3a17e", "c93c7316819e14cbb9a7a89aa505bfd0");
